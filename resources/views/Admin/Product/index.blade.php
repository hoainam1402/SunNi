                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a href="{{ route('product.create') }}" class="btn bg-gradient-info btn-sm">
            ...
            var table = $('#table').DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            if(data == null){
                                return '<em>{{ __('messages.avatar_null') }}</em>';
                            }
                            else {
                                return '<img class="border border-secondary" src="{{ asset('') }}' + data +'" width="45" height="30">';
                            }
